<?php
	...
	$send_address   = "your@name.com";	// Replace your email address
	$send_password	= "pass";				// Replace your email password
	$send_server	= "maiwordl.domain.com";	// Replace your email server address
