  ...
  $(function() {
    ...
    if ($("#priceFrom").length != 0) {
      $("#priceFrom").change(function() {
        ...
        if (isNaN(value) == false) $("#price-range").slider("values", 0, value);
      });
    }
    ...
    if ($("#priceTo").length != 0) {
      $("#priceTo").change(function() {
        var value = parseInt($(this).val());
        if (isNaN(value) == false) $("#price-range").slider("values", 1, value);
      });
    }
    ...
    if ($(".jq-selectbox__dropdown ul li").length != 0) {
      $(".jq-selectbox__dropdown ul li").click(function() {
        ...
        $(this)
          .parent("ul")
          .find("li")
          .attr("data-jqfs-class", "attribute-checkbox");
        $(this)
          .parent("ul")
          .parent(".jq-selectbox__dropdown")
          .parent(".jq-selectbox")
          .find(".select-styler")
          .find("option")
          .removeClass("selected");
...
$(document).ready(function() {
  ...
  if ($(".material-item").length > 0) {
    ...
    $materialItem.click(function() {
      ...
      $magnifierContainer.html(
        '<div class="image-circle"><img src="' + magnifierImage + '" /></div>'
      );
    });
  }
